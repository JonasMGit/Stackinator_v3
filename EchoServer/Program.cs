...
namespace EchoServer
{
    class MainClass
    {
        ...
        {
            //sets up the original database: beverages, condiments, confectionaries
            ...
            try
            {
                if (stream.CanRead)
                {
                    ...
                    if (request.Method.Equals("{}"))
                    {
                        ...
                        SendResponse(new Response("missing method"), stream);
                    ...
                    try
                    {
                        JObject _request = (JObject)JObject.ToString();
